...
urlpatterns = [
    ...
    path('<int:id>/', show_merchandise, name='show_merchandise'),
    path('create/', create_merchandise_ajax, name='create_merchandise_ajax'),
    path('edit/<int:id>/', edit_merchandise_ajax, name='edit_merchandise_ajax'),
    path('delete/<int:id>/', delete_merchandise_ajax, name='delete_merchandise_ajax'),
